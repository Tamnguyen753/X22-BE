const messages = {
  invalidData: "Thông tin không hợp lệ",
  ...
  notFoundUsernameAndEmail: "Không tìm thấy tên đăng nhập và email tương ứng",
  resetPasswordEmailHasSent:
    "Đã có mail thiết lập lại mật khẩu gửi về email của bạn. Vui lòng kiểm tra",
  ...
  managerHasNoRestaurant: "Quản lý chưa đăng ký thông tin nhà hàng",
  managerAlreadyHasRestaurant: "Đã tạo nhà hàng trước đó"
};
